...
setup(
    ...
    version = '0.0.1',  # METADATA_RESET:    version = '<<version>>',
    ...
    packages=find_packages(exclude=['contrib', 'docs', 'tests', 'PyHatch.cfg']),
    ...
    #   (binary only ???, i.e. bdist not sdist)
    #package_data={
    #    'pyhatch': [],
    #},
