...
# -*- coding: utf-8 -*-
#
# PyHatch documentation build configuration file, created by
...
target_file = os.path.join( up_one, 'pyhatch','_version.py')
...
latex_documents = [
  (master_doc, 'PyHatch.tex', u'PyHatch Documentation',
...
man_pages = [
    (master_doc, 'projectabcxyz', u'PyHatch Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'PyHatch', u'PyHatch Documentation',
   author, 'PyHatch', 'One line description of project.',
   'Miscellaneous'),
]
