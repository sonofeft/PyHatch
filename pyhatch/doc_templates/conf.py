...
# -*- coding: utf-8 -*-
#
# {{projName}} documentation build configuration file, created by
...
target_file = os.path.join( up_one, '{{projName_lower}}','_version.py')
...
release = __version__  # METADATA_RESET:release = '<<version>>'
...
latex_documents = [
  (master_doc, '{{projName}}.tex', u'{{projName}} Documentation',
   u'{{author}}', 'manual'),
]
...
man_pages = [
    (master_doc, 'projectabcxyz', u'{{projName}} Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, '{{projName}}', u'{{projName}} Documentation',
   author, '{{projName}}', 'One line description of project.',
   'Miscellaneous'),
]
