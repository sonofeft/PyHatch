...
if __name__ == "__main__":
    ...
    metadataD =  {"<<version>>":"{{version}}"}

    # render_file( os.path.abspath('./docs/conf.py'), metadataD )
    # render_file( os.path.abspath('./setup.py'), metadataD )
    render_file( os.path.abspath('./{{projName_lower}}/_version.py'), metadataD )
    # render_file( os.path.abspath('./{{projName_lower}}/{{mainPyFileName}}'), metadataD )
